...
In this directory are implementations of some design patterns.
...
`remove`, and retrieved by calling `get`.
...
objects of different types that are identified by a hashable key. The class is
